...
module mkFPU(CLK,
  ...
  reg CASE_fpu_div_fOperands_S0D_OUT_BITS_2_TO_0_0__ETC__q9,
      ...
      CASE_guard05360_0b0_resWirewget_BIT_68_0b1_re_ETC__q146,
      ...
      CASE_guard95398_0b0_NOT_resWirewget_BIT_68_0b_ETC__q147,
  ...
  always@(rmdFifo$D_OUT or
	  resWire$wget or
	  CASE_guard05360_0b0_resWirewget_BIT_68_0b1_re_ETC__q146 or
	  guard__h305360)
  begin
    case (rmdFifo$D_OUT)
      3'd0:
  ...
  always@(rmdFifo$D_OUT or
	  resWire$wget or
	  CASE_guard95398_0b0_NOT_resWirewget_BIT_68_0b_ETC__q147 or
	  guard__h295398)
  begin
    case (rmdFifo$D_OUT)
      3'd0:
